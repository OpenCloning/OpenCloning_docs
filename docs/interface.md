---
description: Guide to the OpenCloning user interface including sequence editor, cloning tab, primer table, and settings. Learn how to navigate and use all features of the application.
---
...
![Screenshot showing the main navigation tabs in OpenCloning: Cloning, Primers, Description, Sequence, Data model, and Settings](../assets/interface_tabs.png)
</div>
...
<div markdown style="max-width: 400px" class="img-container">
![Animation demonstrating how to use the plus icon to select cloning methods for a sequence](../assets/interface_use_for_cloning.gif)
</div>
...
<div markdown style="max-width: 400px" class="img-container">
![Screenshot showing the eye icon button to open a sequence in the sequence viewer](../assets/interface_eye.png)
</div>
...
![Screenshot of the OpenCloning sequence editor showing sequence viewer with multiple tabs and properties panel](../assets/interface_editor.png)
</div>
...
<div markdown style="max-width: 400px" class="img-container">
![Screenshot showing the pencil icon to rename a sequence in OpenCloning](../assets/interface_rename.png)
</div>
...
<div markdown style="max-width: 400px" class="img-container">
![Screenshot showing the trash icon to delete a sequence and its source in OpenCloning](../assets/interface_delete_sequence.png)
</div>
...
<div markdown style="max-width: 400px" class="img-container">
![Animation showing how to hide and show ancestor sequences using the eye icon in OpenCloning](../assets/interface_hide_ancestors.gif)
</div>
